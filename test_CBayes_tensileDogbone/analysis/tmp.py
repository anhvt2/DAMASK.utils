...
for folder in folders:
    ...
    porosities.append({'global': tmp[0], 'local': tmp[1], 'target': tmp[2]})
...
plt.figure(num=None, figsize=(20, 14), dpi=300, facecolor='w', edgecolor='k')
...
plt.xlabel(r'global $\phi$', fontsize=24)
plt.ylabel(r'local (gauge) $\phi$', fontsize=24)
plt.savefig('test.png', dpi=300, facecolor='w', edgecolor='w', orientation='portrait', format=None, transparent=False, bbox_inches='tight', pad_inches=0.1, metadata=None)
