...
numVoidVoxels = np.floor(numSolidVoxels * voidPercentage / 100).astype(int)
...
voidOrientations = np.random.rand(numVoidVoxels+1, 3) * (ubEulerAngles - lbEulerAngles) + lbEulerAngles # +1 to include air
