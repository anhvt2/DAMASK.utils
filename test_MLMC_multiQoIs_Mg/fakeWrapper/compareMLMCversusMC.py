...
varepsilon, num_samples, computational_cost, rmse = mc_cost[:,0], mc_cost[:,1], mc_cost[:,2], mc_cost[:,3]

plt.plot(rmse, computational_cost, color='tab:red', linestyle='-', marker='o', 
