...
get_cmd(index::Index, nb_of_qoi) = Cmd(["python3", "hybridwrapper_multilevel_multiple_qoi.py", index isa Level ? "--level" : "--index", string(index), "--nb_of_qoi", string(nb_of_qoi)])
