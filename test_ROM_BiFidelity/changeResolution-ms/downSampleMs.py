...
subprocess.run(["python3", "../../npy2geom.py", "--npy",
               f"{outFileName}.npy"], check=True)
subprocess.run(["python3", "../../npy2png.py", "--threshold",
...
for zoomFactor, resolution in zip(zoomFactors, resolutions):
    mlf = scipy.ndimage.zoom(mhf, zoom=(
        zoomFactor, zoomFactor, zoomFactor), mode='constant', order=0)
