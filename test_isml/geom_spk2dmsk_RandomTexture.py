...
"""
	Example
	-------
		python3 geom_spk2dmsk_RandomTexture.py -r 50 -d 'dump.0.out' --phaseFileName='phase_dump_12_out.npy'
...
###
orientations = np.random.rand(num_grains+1, 3) * np.array([360, 180, 360]) # bounds obtained from DREAM.3D
