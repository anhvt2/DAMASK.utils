function xNext = getNextSamplingPointReduceMSE(hyp, meanfunc, covfunc, likfunc, hypClf, meanfuncClf, covfuncClf, likfuncClf, acquisitionFunction, xLB, xUB, S, Y, F)
	...
	xNext = cmaes('calculateNegativeMSE', xInitCMAES, sigma, OPTS, hyp, meanfunc, covfunc, likfunc, S, Y); 
