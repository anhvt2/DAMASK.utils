...
%% simulation settings
modelName = 'MonteCarloSS304L'; % declare model name -- must match with "_Template/"
queryShellScript = 'sbatch.damask.solo'; % query Shell script -- end-to-end, from input.dat to 
