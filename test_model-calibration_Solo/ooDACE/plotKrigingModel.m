...
if inDim == 1
    ...
    if iscell( samples )
        ...
        % plot( ax(1), samples{2}, values{2}, 'bo', 'MarkerEdgeColor','b', 'MarkerFaceColor','b', 'MarkerSize',10 ); % edit by AT
    else
    ...
    if iscell( samples )
        ...
        % plot3( samples{2}(:,1), samples{2}(:,2), values{2}, 'bo', 'MarkerEdgeColor','b', 'MarkerFaceColor','b', 'MarkerSize',10 ); % edit by AT
    else
    ...
    if iscell( samples )
        ...
        % plot( samples{2}(:,1), samples{2}(:,2), 'bo', 'MarkerEdgeColor','b', 'MarkerFaceColor','b' ); % edit by AT
    else
