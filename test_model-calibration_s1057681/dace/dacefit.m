function  [dmodel, perf] = dacefit(S, Y, regr, corr, theta0, lob, upb, xLB, xUB)
...
%    origS  : original S -- added by AT
%    origY  : original Y -- added by AT
%    xLB    : domain lower bounds -- added by AT
%    xUB:   : domain upper bounds -- added by AT
...
dmodel = struct('regr',regr, 'corr',corr, 'theta',theta.', ...
  ...
  'origS', origS, 'origY', origY, ... % edited by AT
  'C',fit.C, 'Ft',fit.Ft, 'G',fit.G, ...
  'xLB', xLB, 'xUB', xUB); % edit by AT
