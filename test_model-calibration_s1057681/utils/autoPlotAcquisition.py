...
mpl.use('Agg') # 'Agg' or 'pdf'

# plot portfolio
fig = plt.figure(num=None, figsize=(20, 11.3), dpi=300, facecolor='w', edgecolor='k')
...
plt.savefig('acquisitionPortfolio_' + os.getcwd().split('/')[-1] + '.png', dpi=None, facecolor='w', edgecolor='w',
...
# plt.show()
plt.savefig('acquisitionTrack_' + os.getcwd().split('/')[-1] + '.png', dpi=None, facecolor='w', edgecolor='w',
        orientation='portrait', papertype=None, format=None,
        transparent=False, bbox_inches=None, pad_inches=0.1,
        frameon=None, metadata=None)
