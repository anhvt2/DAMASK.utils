...
defaultPath=$(grep -inr 'OutputPath' ${inputFile}  | head -n 1  | cut -d: -f3 | cut -c 3- | rev | cut -c 3- | rev) # not ${inputFile}.json

# convert from 
# 64:        "OutputPath": "/qscratch/anhtran/DAMASK/DAMASK-2.0.2/examples/SpectralMethod/Polycrystal/testMLMC_14Apr21/DAMASK.utils/test_MLMC_runs/64x64x64"
# to 
