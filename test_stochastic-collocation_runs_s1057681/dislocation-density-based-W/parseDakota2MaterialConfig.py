...
def getDamaskParams(sg_input):
  ...
  lower_bounds = [1e10, 1e2, 1.64, 0.25, 1.2, 1.5e-19,  5]
  upper_bounds = [5e12, 1e4, 2.42, 0.70, 1.8, 3.5e-19, 20]
...
def parseInput(real_sg_input, txtcfg):
  ...
  # parsed_txtcfg[57 - 1] = 'v0                  1.0e4           # Initial glide velocity [m/s]: old value "1.0e-4: corrected to be "1.0e4", cf. Sedighiani et al. 2022 Mech. of Matls.\n'
