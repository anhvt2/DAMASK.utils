...
g = sns.jointplot(data=df, x=r"$\varepsilon_Y$", y=r"$\sigma_Y$", kind="kde", xlim=(0.0025, 0.008), ylim=(50,150)) #, marker='o')
...
g.ax_joint.xaxis.set_major_locator(ticker.MultipleLocator(0.0015))
