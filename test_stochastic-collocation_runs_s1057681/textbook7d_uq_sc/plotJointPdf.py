...
g = sns.jointplot(data=df, x=r"$\varepsilon_Y$", y=r"$\sigma_Y$", kind="kde", xlim=(0.002, 0.004), ylim=(200,700)) #, marker='o')
...
g.ax_joint.xaxis.set_major_locator(ticker.MultipleLocator(0.0005))
g.ax_joint.yaxis.set_major_locator(ticker.MultipleLocator(50))
