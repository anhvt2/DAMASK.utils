...
/* Matt Knepley - Thu May 22 15:13:26 CDT 1997                                */
/* I want to use the debugging allocation routines from PETSc so when I get   */
/* arrays from Triangle, PetscFree() does not barf.                           */
#ifndef NO_PETSC_MALLOC
  #define __FUNC__ ""
  #define __SDIR__ ""
  extern int (*PetscTrMalloc)(int,int,char*,char*,char*,void**);
  extern int (*PetscTrFree)(void *,int,char*,char*,char*);
  void *crapPointer;
  #define malloc(a) ((*PetscTrMalloc)(a,__LINE__,__FUNC__,__FILE__,__SDIR__, &crapPointer), crapPointer)
  #define free(a)   (*PetscTrFree)(a,__LINE__,__FUNC__,__FILE__,__SDIR__)
#else /* Stefano Zampini - Thu Nov 22 10:35:29 +03 2018: we need to include stdlib.h for malloc */
  #include <stdlib.h>
#endif /* NO_PETSC_MALLOC */
